...
export const idlService = IDL.Service({
  ...
  'addBanner' : IDL.Func([IDL.Text], [IDL.Text], []),
  'addProduct' : IDL.Func(
      [IDL.Text, IDL.Nat, IDL.Text, IDL.Vec(ExternalBlob)],
      [Product],
      [],
    ),
  ...
  'getBanners' : IDL.Func([], [IDL.Vec(IDL.Text)], ['query']),
  ...
  'setFeaturedProduct' : IDL.Func([IDL.Text, IDL.Bool], [], []),
  ...
  'updateProduct' : IDL.Func(
      [IDL.Text, IDL.Text, IDL.Nat, IDL.Text, IDL.Vec(ExternalBlob)],
      [Product],
      [],
    ),
});
