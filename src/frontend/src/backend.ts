...
import type { CartItem as _CartItem, CartSummary as _CartSummary, ExternalBlob as _ExternalBlob, Product as _Product, StripeSessionStatus as _StripeSessionStatus, UserRole as _UserRole, _CaffeineStorageRefillInformation as __CaffeineStorageRefillInformation, _CaffeineStorageRefillResult as __CaffeineStorageRefillResult } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addBanner(arg0: string): Promise<string> {
        if (this.processError) {
            try {
    ...
    async addProduct(arg0: string, arg1: bigint, arg2: string, arg3: Array<ExternalBlob>): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(arg0, arg1, arg2, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg3));
    ...
    async getBanners(): Promise<Array<string>> {
        if (this.processError) {
            try {
    ...
    async getCartSummary(): Promise<CartSummary> {
        if (this.processError) {
            try {
                ...
                return from_candid_CartSummary_n18(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async setFeaturedProduct(arg0: string, arg1: boolean): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.setFeaturedProduct(arg0, arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateProduct(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: Array<ExternalBlob>): Promise<Product> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, arg1, arg2, arg3, await to_candid_vec_n8(this._uploadFile, this._downloadFile, arg4));
                return from_candid_Product_n10(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
async function from_candid_CartItem_n21(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CartItem): Promise<CartItem> {
    return await from_candid_record_n22(_uploadFile, _downloadFile, value);
}
async function from_candid_CartSummary_n18(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CartSummary): Promise<CartSummary> {
...
async function from_candid_record_n11(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        id: value.id,
        imageRefs: await from_candid_vec_n12(_uploadFile, _downloadFile, value.imageRefs),
        name: value.name,
...
async function from_candid_record_n19(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        items: await from_candid_vec_n20(_uploadFile, _downloadFile, value.items)
    };
}
async function from_candid_record_n22(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        product: await from_candid_Product_n10(_uploadFile, _downloadFile, value.product)
    };
}
...
async function from_candid_vec_n20(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_CartItem>): Promise<Array<CartItem>> {
    return await Promise.all(value.map(async (x)=>await from_candid_CartItem_n21(_uploadFile, _downloadFile, x)));
}
